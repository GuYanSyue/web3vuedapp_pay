...
<template>
  <div class="flex flex-col items-center">
    ...
    <div v-if="account" class="outsidebox">
      ...
      <div v-if="sum === 0">
        <button class="bg-cyan-600 rounded p-4 mt-10 b-color" @click="new_onSign(crypto_.totalPrice.value)">
          確認簽名
        </button>
      </div>
      <div class="box">
      ...
      <button class="bg-red-600 rounded p-4 mt-10 b-color" @click="deposit(crypto_.totalPrice.value)">
        確認付款
      </button>
